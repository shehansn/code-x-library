...
class BuisnessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view:View = inflater.inflate(R.layout.fragment_buisness, container, false)

        btnbacktohome = view.findViewById(R.id.btnbacktohome)

        btnbacktohome.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_buisnessFragment_to_homeFragment2)
        }
