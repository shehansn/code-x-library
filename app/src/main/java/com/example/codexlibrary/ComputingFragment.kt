...
class ComputingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view:View = inflater.inflate(R.layout.fragment_computing, container, false)

        btnbacktohome = view.findViewById(R.id.btnbacktohome)

        btnbacktohome.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_computingFragment_to_homeFragment2)
        }
